...
if (number===0) {
    document.body.innerHTML += 'číslo je 0, zelená'
        ...
        if ((number>=1 && number <= 10) || (number >=19 && number <= 28)) {
            ...
            if (number%2===0) {
                document.body.innerHTML += 'číslo je sudé, černá'
            }else {
                document.body.innerHTML += 'číslo je liché, červená'
            }
        } else if ((number>=11 && number <= 18) || (number >=29 && number <= 36)){
                    
            if (number%2===0) {
                document.body.innerHTML += 'číslo je sudé, červená'
            }
            else {document.body.innerHTML += 'číslo je liché, černá'}}}
